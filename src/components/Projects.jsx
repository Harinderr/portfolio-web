    ...
    <h1 className="text-center py-10">Pro<span id="black">jects</span></h1>
        <div className="Projects_container flex flex-row justify-items-center h-90">
            ...
            <div className="Project bg-slate-100  p-4 text-center">
                ...
                <p className="text-black pt-2">It is a clone of Flipkart build with HTML, css and Javascript. </p>
                <a href="https://www.flipkart.com">https://www.flipkart.com</a>
            </div>
            <div className="Project bg-slate-100  p-4 text-center">
                <img src='/netflix.jpg' alt="no image" />
                <p className="text-black pt-2">It is a clone of Netflix which is made in pure HTML, css and Javascript.</p>
            ...
            <div className="Project   p-4 text-center">
                <img src="groceo.webp" alt="" />
                <p className="text-black pt-2">It is a clone of Groceo, with modern Styles and functioning.</p>
                <a href="https://www.groceo.com">https://www.groceo.com</a>
            </div>
        </div>
        </div>
    )
